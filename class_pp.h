...
public:
    class_pp();
    QString rs_id, client_id, type, type_doc, num, date, date_oper, sum, ticket_date, ticket_time, ticket_value, payer_count;
    ...
    QString pokazatel_num, pokazatel_date, pokazatel_type, ocherednost, srok_accepta, type_akkred, srok_pay;
    QString usl_pay1, usl_pay2, usl_pay3, pay_po_predst, dop_usl, num_scheta_postav, date_send_doc;
};
